...
conf = nthmc.Conf(nbatch=1024, nepoch=4, nstepEpoch=512, nstepMixing=64, initDt=0.5, trainDt=False, refreshOpt=False, nthr=4)
nthmc.setup(conf)
...
loss = nthmc.LossFun(action, cCosDiff=1.0, cTopoDiff=1.0, dHmin=1.0, topoFourierN=1)
opt = tk.optimizers.Adam(learning_rate=0.0002)
