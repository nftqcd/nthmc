...
conf = nthmc.Conf(nbatch=512, nepoch=1, nstepEpoch=1024, nstepMixing=256, initDt=0.4, refreshOpt=False, nthr=40, nthrIop=2)
beta=3.5
nthmc.setup(conf)
...
beta=6.0
conf.nepoch=4
conf.nstepEpoch=1536
conf.nstepMixing=512
action = nthmc.OneD(beta=beta, beta0=3.5, size=256, transform=nthmc.TransformChain([
