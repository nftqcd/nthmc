...
op0 = (((1,2,-1,-2), (1,-2,-1,2)),)
op1 = (((2,-1,-2,1), (2,1,-2,-1)),)
conv = lambda: ftr.Scalar(output=1, init=0.1355)    # atan(0.1355)/pi ~ 0.04287  c.f. GenericStoutSmear.beta
                                                    # the value in s_nthmc_l64_b6_startb6.log for beta=6 is ~0.686, which has a factor of 16 due to TransformChain's accumulation
...
forcetrain.runInfer(conf, actionFun, mcmcFun, x0=x0, saveFile='configs/s_fthmc_l64_b6/conf')
