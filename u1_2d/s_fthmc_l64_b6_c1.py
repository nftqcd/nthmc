...
op0 = (((1,2,-1,-2), (1,-2,-1,2)),)
op1 = (((2,-1,-2,1), (2,1,-2,-1)),)
conv = lambda: ftr.Scalar(output=1, init=math.tan(math.pi*0.1))     # coeff = atan(x)/pi  c.f. GenericStoutSmear.beta
...
forcetrain.runInfer(conf, actionFun, mcmcFun, x0=x0, saveFile='configs/s_fthmc_l64_b6_c1/conf')
