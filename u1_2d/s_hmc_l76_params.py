...
actionFun = lambda: nthmc.U1d2(beta=13.*fac, beta0=0.0, size=(76,76), transform=ftr.Ident(), nbatch=conf.nbatch, rng=rng.split()[0])
mcmcFun = lambda action: nthmc.Metropolis(conf, evolve.Omelyan2MN(conf, action))

forcetrain.runInfer(conf, actionFun, mcmcFun, saveFile='conf.s_hmc_l76_params')
