...
conf = nthmc.Conf(nbatch=32, nepoch=5, nstepEpoch=1024, nstepMixing=128, initDt=trajLength/nstep, stepPerTraj=nstep, trainDt=False, nthr=10, nthrIop=1, seed=7*11*13)
op0 = (((1,2,-1,-2), (1,-2,-1,2)),
...
x0 = tf.constant(numpy.load('configs/s_hmc_l64_b3/conf.b3.0.n128.l64_64.08192.npy')[0:32], dtype=tf.float64)
forcetrain.runInfer(conf, actionFun, mcmcFun, x0=x0, saveFile='configs/s_nthmc_l64_b3/conf', transformWeights='weights/t_force_b25_l64_b3')
