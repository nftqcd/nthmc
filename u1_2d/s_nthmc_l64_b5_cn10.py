...
conf = nthmc.Conf(nbatch=32, nepoch=4, nstepEpoch=1024, nstepMixing=128, initDt=trajLength/nstep, stepPerTraj=nstep, trainDt=False, nthr=10, nthrIop=1, seed=7*11*13*7*15)
op0 = (((1,2,-1,-2), (1,-2,-1,2)),
...
forcetrain.runInfer(conf, actionFun, mcmcFun, x0=x0, saveFile='configs/s_nthmc_l64_b5_cn10/conf', transformWeights='weights/t_force_b25_l64_b5_cn10')
