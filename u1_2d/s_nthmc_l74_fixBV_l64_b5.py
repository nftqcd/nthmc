...
actionFun = lambda: nthmc.U1d2(beta=5.*fac, beta0=0.0, size=(74,74), transform=transform(), nbatch=conf.nbatch, rng=rng.split()[0])
mcmcFun = lambda action: nthmc.Metropolis(conf, evolve.Omelyan2MN(conf, action))

x0 = tf.constant(numpy.load('configs/conf.s_hmc_l74_params.b6.6845703125.n128.l74_74.08192.npy')[0:32], dtype=tf.float64)
forcetrain.runInfer(conf, actionFun, mcmcFun, x0=x0, saveFile='configs/s_nthmc_l74_fixBV_l64_b5/conf', transformWeights='weights/t_force_b25_l64_b5')
