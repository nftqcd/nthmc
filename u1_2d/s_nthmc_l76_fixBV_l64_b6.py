...
actionFun = lambda: nthmc.U1d2(beta=6.*fac, beta0=0.0, size=(76,76), transform=transform(), nbatch=conf.nbatch, rng=rng.split()[0])
mcmcFun = lambda action: nthmc.Metropolis(conf, evolve.Omelyan2MN(conf, action))

x0 = tf.constant(numpy.load('configs/conf.s_hmc_l76_params.b8.4609375.n128.l76_76.08192.npy')[0:32], dtype=tf.float64)
forcetrain.runInfer(conf, actionFun, mcmcFun, x0=x0, saveFile='configs/s_nthmc_l76_fixBV_l64_b6/conf', transformWeights='weights/t_force_b25_l64_b6')
