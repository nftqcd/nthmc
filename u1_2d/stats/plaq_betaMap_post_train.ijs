...
betaForFile=: 4 :0
	...
	plaq=.}.getRes'9 awk ''/^betaMap:/{if(b==1)exit;b=0;p=0} /^betaMap: ',betastr,'$/{b=1} b==1&&/^# post-training inference step/{p=1} p==1&&/^plaq:/{print;p=0}'' ',y
	pmap=.}.getRes'9 awk ''/^betaMap:/{if(b==1)exit;b=0;p=0} /^betaMap: ',betastr,'$/{b=1} b==1&&/^# post-training inference step/{p=1} p==1&&/^plaqWoTrans:/{print;p=0}'' ',y
	nconf=.#plaq
