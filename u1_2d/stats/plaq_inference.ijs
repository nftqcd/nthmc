...
betaForFile=: 4 :0
	betastr=.display x
	echo 'beta: ',betastr
	plaq=.}.getRes'9 awk ''/^beta:/{if(b==1)exit;b=0;p=0} /^beta: ',betastr,'$/{b=1} b==1&&/^# inference step/{p=1} p==1&&/^plaq:/{print;p=0}'' ',y
	pmap=.}.getRes'9 awk ''/^beta:/{if(b==1)exit;b=0;p=0} /^beta: ',betastr,'$/{b=1} b==1&&/^# inference step/{p=1} p==1&&/^plaqWoTrans:/{print;p=0}'' ',y
	nconf=.#plaq
