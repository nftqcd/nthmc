...
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, loadWeights='weights/t_force_b25_l64_b4_cn8', saveWeights='weights/t_force_b25_l64_b5_step1e-4_p7o16_5cn6_5cn8', optChange=forcetrain.LRSteps([(conf.nstepEpoch*7/16, 0.0001), (conf.nstepEpoch*7/8, 0.00001), (conf.nstepEpoch, 0.0000001)]))
