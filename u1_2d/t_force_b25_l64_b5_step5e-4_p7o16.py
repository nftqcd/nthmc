...
loss = lambda action: forcetrain.LossFun(action, betaMap=2.5, cNorm2=1.0, cNorm4=1.0, cNorm6=1.0, cNorm8=1.0, cNorm10=0.0, cNormInf=1.0)
opt = tk.optimizers.Adam(learning_rate=0.00005)
...
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, loadWeights='weights/t_force_b25_l64_b4_cn8', saveWeights='weights/t_force_b25_l64_b5_step5e-4_p7o16', optChange=forcetrain.LRSteps([(conf.nstepEpoch*7/16, 0.0005), (conf.nstepEpoch*7/8, 0.00005), (conf.nstepEpoch, 0.0000005)]))
