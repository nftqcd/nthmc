...
loss = lambda action: forcetrain.LossFun(action, betaMap=2.5, cNorm2=1.0, cNorm4=1.0, cNorm6=4.0, cNorm8=4.0, cNorm10=0.0, cNormInf=1.0)
...
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, loadWeights='weights/t_force_b25_l64_b5', saveWeights='weights/t_force_b25_l64_b6_step1e-4_p8_4cn6_4cn8', optChange=forcetrain.LRSteps([(conf.nstepEpoch/8, 0.0001), (conf.nstepEpoch/4, 0.00001), (conf.nstepEpoch, 0.000001)]))
