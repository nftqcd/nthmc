...
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, loadWeights='weights/t_force_b25_l64_b5', saveWeights='weights/t_force_b25_l64_b6_step1e-5_8cn6_8cn8', optChange=forcetrain.LRSteps([(conf.nstepEpoch/4, 0.00001), (conf.nstepEpoch/2, 0.000001), (conf.nstepEpoch, 0.0000001)]))
