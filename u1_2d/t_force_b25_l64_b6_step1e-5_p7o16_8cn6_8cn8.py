...
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, loadWeights='weights/t_force_b25_l64_b5', saveWeights='weights/t_force_b25_l64_b6_step1e-5_p7o16_8cn6_8cn8', optChange=forcetrain.LRSteps([(conf.nstepEpoch*7/16, 0.00001), (conf.nstepEpoch*7/8, 0.000001), (conf.nstepEpoch, 0.00000001)]))
