...
loss = lambda action: forcetrain.LossFun(action, betaMap=2.5, cNorm2=1.0, cNorm4=1.0, cNorm6=8.0, cNorm8=8.0, cNorm10=0.0, cNormInf=1.0)
opt = tk.optimizers.Adam(learning_rate=0.0000001)
...
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, loadWeights='weights/t_force_b25_l64_b5', saveWeights='weights/t_force_b25_l64_b6_step1e-6_p7o16_8cn6_8cn8', optChange=forcetrain.LRSteps([(conf.nstepEpoch*7/16, 0.000001), (conf.nstepEpoch*7/8, 0.0000001), (conf.nstepEpoch, 0.000000001)]))
