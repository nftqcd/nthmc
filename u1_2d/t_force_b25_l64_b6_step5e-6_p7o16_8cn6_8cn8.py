...
opt = tk.optimizers.Adam(learning_rate=0.0000005)
...
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, loadWeights='weights/t_force_b25_l64_b5', saveWeights='weights/t_force_b25_l64_b6_step5e-6_p7o16_8cn6_8cn8', optChange=forcetrain.LRSteps([(conf.nstepEpoch*7/16, 0.000005), (conf.nstepEpoch*7/8, 0.0000005), (conf.nstepEpoch, 0.000000005)]))
