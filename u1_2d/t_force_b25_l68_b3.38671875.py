...
fac = (68./64.)**2
conf = nthmc.Conf(nbatch=128, nepoch=1, nstepEpoch=1024, nstepMixing=128, nstepPostTrain=1024, initDt=0.2, stepPerTraj=10, nthr=20, nthrIop=2, seed=11*1234567)
nthmc.setup(conf)
op0 = (((1,2,-1,-2), (1,-2,-1,2)),
...
actionFun = lambda: nthmc.U1d2(beta=3.*fac, beta0=3.*fac, size=(68,68), transform=transform(), nbatch=conf.nbatch, rng=rng.split()[0])
...
loadConf = lambda n: tf.constant(numpy.load(f'configs/s_hmc_l68_b3.38671875/conf.b3.38671875.n128.l68_68.{64*(n+1):05d}.npy', allow_pickle=False, fix_imports=False), dtype=tf.float64)
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, saveWeights='weights/t_force_b25_l68_b3.38671875')
