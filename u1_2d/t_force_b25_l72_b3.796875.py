...
fac = (72./64.)**2
conf = nthmc.Conf(nbatch=128, nepoch=1, nstepEpoch=1024, nstepMixing=128, nstepPostTrain=1024, initDt=0.2, stepPerTraj=10, nthr=20, nthrIop=2, seed=11*123456*7)
nthmc.setup(conf)
op0 = (((1,2,-1,-2), (1,-2,-1,2)),
...
actionFun = lambda: nthmc.U1d2(beta=3.*fac, beta0=3.*fac, size=(72,72), transform=transform(), nbatch=conf.nbatch, rng=rng.split()[0])
...
loadConf = lambda n: tf.constant(numpy.load(f'configs/s_hmc_l72_b3.796875/conf.b3.796875.n128.l72_72.{256*(n+1):05d}.npy', allow_pickle=False, fix_imports=False), dtype=tf.float64)
forcetrain.trainWithConfs(conf, loadConf, actionFun, loss, opt, saveWeights='weights/t_force_b25_l72_b3.796875')
