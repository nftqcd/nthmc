...
conf = nthmc.Conf(nbatch=4, nepoch=5, nstepEpoch=1024, nstepMixing=128, nstepPostTrain=1024, stepPerTraj=15, trainDt=False, trajLength=4., nthr=20, nthrIop=2)
nthmc.setup(conf)
op0 = (((1,2,-1,-2), (1,-2,-1,2)),
...
actionFun = lambda: nthmc.U1d2(beta=7.0, beta0=2.0, size=(256,256), transform=transform(), nbatch=conf.nbatch, rng=rng.split()[0])
