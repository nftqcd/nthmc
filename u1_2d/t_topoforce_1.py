...
conf = nthmc.Conf(nbatch=32, nepoch=5, nstepEpoch=1024, nstepMixing=128, initDt=0.1, stepPerTraj=5)
nthmc.setup(conf)
op0 = (((1,2,-1,-2), (1,-2,-1,2)),
...
loss = lambda action: nthmc.LossFun(action, cCosDiff=0.0, cTopoDiff=1.0, cForce2=1.0, dHmin=0.5, topoFourierN=1)
